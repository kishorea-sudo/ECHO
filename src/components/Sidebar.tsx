...
export function Sidebar({ activeTab, onTabChange }: SidebarProps) {
  return (
    <div className="w-64 h-full bg-sidebar border-r border-sidebar-border flex flex-col">
      <div className="p-4">
        <h2 className="text-base lg:text-lg font-medium text-sidebar-foreground mb-4">ECHO Navigation</h2>
          ...
          {navigationItems.map((item) => {
            ...
            return (
              <Button
                ...
                variant="ghost"
                className={cn(
                  "w-full justify-start px-3 py-2 h-auto transition-all duration-200 hover:bg-sidebar-accent group text-sm lg:text-base",
      ...
      <div className="mt-auto p-4 border-t border-sidebar-border">
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            <span className="text-xs lg:text-sm text-sidebar-foreground">System Status</span>
